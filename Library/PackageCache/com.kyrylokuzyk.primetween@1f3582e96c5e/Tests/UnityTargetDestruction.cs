...
public partial class Tests {
    ...
    static int tweensCount => PrimeTweenManager.Instance.tweens.Count; 
    ...
    static void expectTargetDestroyed() {
        LogAssert.Expect(LogType.Error, new Regex(Constants.targetDestroyed));
    }
